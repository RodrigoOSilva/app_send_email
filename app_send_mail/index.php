      		...
      		<div class="row">
      			<div class="col-md-12">
					...
					<div class="card-body font-weight-bold">
						<form action="home.php" method="POST"> <!--processa_envio.php-->
							<div class="form-group">
								<label for="para">Para</label> <!--name=para-->
								<input name="email" type="text" class="form-control" id="para" placeholder="joao@dominio.com.br">
							</div>

							<div class="form-group">
								<label for="assunto">Assunto</label><!--name=assunto-->
								<input name="subject" type="text" class="form-control" id="assunto" placeholder="Assundo do e-mail">
							</div>

							<div class="form-group">
								<label for="mensagem">Mensagem</label><!--name=mensagem-->
